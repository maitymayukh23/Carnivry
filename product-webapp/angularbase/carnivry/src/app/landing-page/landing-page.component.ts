...
export class LandingPageComponent implements OnInit {
  ...
  constructor(private http: HttpClient, public datePipe: DatePipe, private router: Router, private snackbar: MatSnackBar, private managementService: ManagementService, private registrationService: RegistrationService) {
  ...
  wishlist(eventId: any, title: string) {
    console.log(this.allEventsList.length);
    if (this.emailId == null) {
      this.router.navigate(['/registration/register']);
